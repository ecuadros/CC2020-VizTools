...
import { AuthService, TableService, ShareGraphService, DKAService } from 'src/app/@core/shared/services';
...
export class CompareToolComponent implements OnInit {
  ...
  optionsUserPrograms: any = {
    filter: (series: Series): boolean => {
      return series.universityId === this.universityId;
    }
  };

  optionsUPrograms: any = {
    filter: (series: Series): boolean => {
      return series.universityId !== this.universityId;
    }
  };
